...
int main()
{
    cout<<"Enter trace or stats what do you want ?"<<endl;
    cout<<"Enter a  comma-separated list telling which CPU scheduling policies to be analyzed/visualized along with their parameters"<<endl;
    cout<<"Enter an  integer specifying the last instant to be used in your simulation and to be shown on the timeline"<<endl;
    cout<<"Enter an integer specifying the number of processes to be simulated"<<endl;
    cout<<"Start of description of processes. Each process is to be described on a separate line"<<endl;
     cout<<"For algorithms 1 through 7, each process is described using a comma-separated list specifying"<<endl;
    cout<<"1- String specifying a process name"<<endl;
    cout<<"2- Arrival Time"<<endl;
    cout<<"3- Service Time"<<endl;

    cout<<"For Aging algorithm (algorithm 8), each process is described using a comma-separated list specifying"<<endl;
     cout<<"1- String specifying a process name"<<endl;
     cout<<"2- Arrival Time"<<endl;
     cout<<"3- Priority\n"<<endl;
